...
struct CustomBarAnimation: View {
    var body: some View {
        ZStack {
            grayBackground
            animationDots
    ...
    private var animationDots: some View {
        ZStack {
            gradientBackground
                .mask {
                    ZStack {
    ...
    private var gradientBackground: some View {
        AngularGradient(colors: [.green, .white, .green, .white, .green], center: .center, startAngle: .degrees(-45), endAngle: .degrees(360-45))
    }
    
    private var msuIcon: some View {
        Image("MSUIcon")
