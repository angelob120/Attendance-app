...
class EventViewModel: ObservableObject {
    ...
    func saveNewEvent(withTitle title: String, venue: String, description: String, date: Date) async throws {
        appState = .loading
        do {
            let event = Events(title: title, venue: venue, description: description, date: date)
    ...
    func delete(_ eventToDelete: Events) async throws {
        appState = .loading
        do {
    ...
    func update(_ updatedEvent: Events) async throws {
        appState = .loading
        do {
